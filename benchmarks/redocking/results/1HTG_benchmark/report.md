...
- target: **1htg** (pdb (resumed))
- receptor: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HTG_benchmark/prepared/receptor.pdbqt` (1839 atoms, engine: openbabel)
- grid box: center (10.38, 22.52, 5.4), size (25.68, 19.85, 16.29) A (source: pocket:G37 chain A residue 300, padding 4.0 A, assumption: strong)
...
> **Redocking pose recovery: best pose RMSD = 3.03 A for g37_redock** - FAIL
...
|---|---|---|---|---|---|
| g37_redock | -10.56 | 3.03 | 9 | -0.192 | 0.0 |
...
- grid box: derived from pocket:G37(A300), padding 4.0 A (assumption: strong)
...
- manifest: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HTG_benchmark/manifest.json`
- environment fingerprint: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HTG_benchmark/environment.json`
- docking summary: `-`
- interactions: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HTG_benchmark/analysis/interactions.json`
- visualization: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HTG_benchmark/visualization`
