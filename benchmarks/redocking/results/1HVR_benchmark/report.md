...
- target: **1hvr** (pdb (resumed))
- receptor: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HVR_benchmark/prepared/receptor.pdbqt` (1846 atoms, engine: openbabel)
...
> **Redocking pose recovery: best pose RMSD = 0.81 A for xk2_redock** - PASS
...
|---|---|---|---|---|---|
| xk2_redock | -11.18 | 0.81 | 9 | -0.243 | 0.0 |
...
- manifest: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HVR_benchmark/manifest.json`
- environment fingerprint: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HVR_benchmark/environment.json`
- docking summary: `-`
- interactions: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HVR_benchmark/analysis/interactions.json`
- visualization: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1HVR_benchmark/visualization`
