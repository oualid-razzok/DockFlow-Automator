...
- target: **1mui** (pdb (resumed))
- receptor: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1MUI_benchmark/prepared/receptor.pdbqt` (1836 atoms, engine: openbabel)
- grid box: center (-8.35, 15.34, 27.98), size (18.86, 16.48, 24.81) A (source: pocket:AB1, padding 4.0 A, assumption: strong)
...
> **Redocking pose recovery: best pose RMSD = 0.47 A for ab1_redock** - PASS
...
|---|---|---|---|---|---|
| ab1_redock | -10.54 | 0.47 | 9 | -0.229 | 0.0 |
...
- grid box: derived from pocket:AB1, padding 4.0 A (assumption: strong)
...
- manifest: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1MUI_benchmark/manifest.json`
- environment fingerprint: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1MUI_benchmark/environment.json`
- docking summary: `-`
- interactions: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1MUI_benchmark/analysis/interactions.json`
- visualization: `/home/z/my-project/dockflow-v030/benchmarks/redocking/results/1MUI_benchmark/visualization`
